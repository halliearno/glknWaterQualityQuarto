...
locations <- read.csv("C:\\Users\\harno\\Documents\\RCode\\station.csv") %>% # Site names and info for all parks 
 mutate(StationID = str_extract(MonitoringLocationIdentifier,"[^\\-]+$")) 

#Extract sites from lake parks spreadsheet
sites_to_get <- locations$MonitoringLocationIdentifier[1:5]
